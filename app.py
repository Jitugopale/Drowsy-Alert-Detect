...
account_sid = 'AC15ac13f7bc2a65e3f00d404b032b4bab'
auth_token = 'e4afa27011cd23b0ba9b3935da66a47c'
                ...
                if flag >= frame_check:
                    if drowsy_start_time is None:
                        ...
                        message = client.messages.create(
                            from_='+19382224945',
                            body='You are drowsy. Stay alert!',
                            to='+919096275725'
                        )
                        print("Message sent:", message.sid)
                        drowsy_start_time = None  # Reset the timer
            else:
                flag = 0
